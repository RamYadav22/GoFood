...
export default function Card(props) {
  ...
  const handleAddToCart = async () => {
    ...
    console.log("foodItem=", foodItem, size);// food ka naam show ho rha h
    ...
    if (food) {
      ...
      await dispatch({ type: "ADD", id: foodItem._id, name: foodItem, price: finalPrice, qty: qty, size: size, img: props.imgSrc });
    }
  }
